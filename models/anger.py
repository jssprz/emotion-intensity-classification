...
class AngerTweetDeepClassifier(BaseEstimator, ClassifierMixin):
  def __init__(self, wordvectors, max_len=15, patience=10):
    self.wordvectors = wordvectors
    self.max_len = max_len

    # Create callbacks
    self.callbacks = [EarlyStopping(monitor='val_auc', mode='max', patience=patience, restore_best_weights=True)]
...
class AngerTweetNRCClassifier(BaseEstimator, ClassifierMixin):
